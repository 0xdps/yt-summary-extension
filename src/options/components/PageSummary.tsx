...
import { Text, Textarea, Card, Button, useToasts, Divider, Toggle, Spacer } from '@geist-ui/core'
...
function PageSummaryComponent(props: PageSummaryProps) {
    ...
    }, [pageSummaryBlacklist, pageSummaryWhitelist, setPageSummaryBlacklist, setPageSummaryWhitelist, setToast])
        ...
        <>
            ...
            <Card>
                <Card.Content>
                    ...
                    >
                        <Toggle initialChecked checked={pageSummaryEnable} onChange={onPageSummaryEnableChange} /> Show
                        Glarity Icon
                    </Text>
                    <Text className="glarity--mt-0" font="12px">
                        Once hidden, the Glarity icon will no longer appear on the page. However, you can open the page
                        summary by clicking on the browser extension icon.
                    </Text>
                </Card.Content>
                <Divider />
                <Card.Content>
