...
function ChatGPTCard(props: Props) {
    ...
    if (triggerMode === TriggerMode.Always || propCurrentTime) {
        return <ChatGPTQuery currentTime={propCurrentTime} question={question} onStatusChange={onStatusChange} />
    }
    ...
    if (triggered) {
        return (
            <>
                <ChatGPTQuery currentTime={propCurrentTime} question={question} onStatusChange={onStatusChange} />
            </>
        )
    }
    return (
