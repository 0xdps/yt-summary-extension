        ...
        return (
            <div className="markdown-body gpt-markdown" id="gpt-answer" dir="auto">
                ...
                {continueConversation && answer.conversationId && done && (
                    <div>
                        <a href={`https://chat.openai.com/c/${answer.conversationId}`} target="_blank" rel="noreferrer">
                        ...
                        if (isBraveBrowser()) {
                            return (
                                <span className="glarity--block glarity--mt-2">
                                    ...
                                    <a href="https://github.com/0xdps/chatgpt-youtube-summary-extension#troubleshooting">
